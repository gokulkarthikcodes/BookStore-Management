...
purchase_date date,
quantity number(3),
foreign key(customerid,storeid,bookid) references purchase(customerid,storeid,bookid),
...
supply_date date,
quantity number(4),
foreign key(supplierid,storeid,bookid) references supply(supplierid,storeid,bookid),
...
foreign key(memployeeid) references manager(employeeid),
